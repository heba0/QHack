...
def variational_ansatz(params, wires):
    ...
    # print(params)
    # print('11111wires',wires)
    # print('11111n_qubits',n_qubits)
    # print('11111params',params)
    if n_rotations > 1:
...
dev2 = qml.device("default.qubit", wires=[0])
...
def variational_ansatz2(params):
    ...
    n_qubits = len(wires)
    n_rotations = len(params)
    # print('22222wires',wires)
    # print('22222n_qubits',n_qubits)
    # print('22222params',params)
    if n_rotations > 1:
        n_layers = n_rotations // n_qubits
        n_extra_rots = n_rotations - n_layers * n_qubits
...
def run_vqe(H):
    ...
    opt = qml.MomentumOptimizer(stepsize=0.055)
    ...
    for n in range(max_iterations):
        ...
        print(variational_ansatz2(params))
        if conv <= conv_tol:
            break
